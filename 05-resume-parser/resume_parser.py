...
Your job is to analyse job description and extract structured information from them.
...
def parse_resume(resume_text):
    ...
    Extract information from the resume based on its meaning, not only based on exact section heading.
    ...
    They all may contain relevant experience.
